...
import AuthScreenWraper from '../../layouts/wraper/AuthScreenWraper';
import BgColor from '../../constant/style/BgColor';
import LogoContant from '../../constant/image/LogoContant';
import { useNavigation } from '@react-navigation/native';
import { userContext } from '../../context/ContextApi';
import api from '../../utils/api/Axios';
import { setFullData, setLocationData } from '../../functions/storage/Storage';
import LottiConstant from '../../constant/lotti/LottiConstant';
import LottiAnimation from '../../layouts/LottiAnimation';
import AuthToken from '../../constant/token/AuthToken';
import UtilsToken from '../../constant/token/UtilsToken';
      ...
      <View
        ...
        <View
          ...
          <LottiAnimation
            ...
            height={150}
            bg={'transparent'}
            path={LottiConstant.productUpload}
          />
          <Text
            style={{
              color: '#FFFFFF',
...
const LoginScreen = () => {
  ...
  const { setUserProfile, setUserTemLocation, setIsAuthNotificationVisible } =
    userContext();
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="flex-1 py-6 px-2">
          ...
          <View className="items-center mt-12 mb-16">
            <View
              className="w-32 h-32 rounded-full bg-white mb-6 border-4 overflow-hidden"
          ...
          <View className="bg-zinc-800/50 p-6 rounded-3xl shadow-2xl backdrop-blur-lg">
            {!showOtpInput ? (
              ...
              <View>
                <View className="mb-8">
                  <Text className="text-zinc-400 mb-3 text-lg">
                    Phone Number
                  </Text>
