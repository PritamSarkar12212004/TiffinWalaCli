  ...
  const data = [
    {
      id: 1,
      image:
        'https://i.pinimg.com/736x/c5/d1/25/c5d125d946ab440151e513629acaddd3.jpg',
      title: 'Special Offer',
    ...
    },
    {
      id: 2,
      image:
        'https://i.pinimg.com/736x/9f/24/56/9f245653e018ea245cfff1c7ad26cd84.jpg',
      title: 'Weekend Deal',
    ...
    },
    {
      id: 3,
      image:
        'https://i.pinimg.com/736x/f9/38/a2/f938a2710c32280a74176e39328a3179.jpg',
      ...
      <View className="flex-row items-center justify-between mb-4">
        <View>
          ...
          <Text className="text-zinc-400 text-sm">
            Manage your active promotions
          </Text>
        </View>
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() => navigation.navigate('Promotions')}
          className="flex-row items-center gap-2 bg-zinc-800 px-4 py-2 rounded-full">
