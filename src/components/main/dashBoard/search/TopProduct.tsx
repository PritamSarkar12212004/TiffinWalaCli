...
const TopProduct = ({ top3Product }: any) => {
    ...
    return (
        <View className='w-full flex gap-4 py-2'>
            <View className='w-full flex flex-row gap-4 items-center  flex-wrap'>
                {
                            ...
                            <View className='relative'>
                                ...
                                <View className='absolute bottom-2 right-2 flex flex-row gap-3 bg-black/30 px-2 py-1 rounded-full'>
                                    <View className='flex flex-row items-center gap-1'>
                                        <FIcon name='heart' size={12} color='#ff4757' />
                                        <Text className='text-white text-sm '>{item.productLikes.length}</Text>
                                    </View>
                                    <View className='flex flex-row items-center gap-1'>
                                        <FIcon name='eye' size={12} color='#ffa502' />
                                        <Text className='text-white text-sm'>{item.postTotalViews}</Text>
                                    </View>
                                </View>
                            </View>
