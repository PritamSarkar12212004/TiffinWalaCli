...
import {getFullData} from '../functions/storage/Storage';
...
export const ContextProvider = ({children}: {children: React.ReactNode}) => {
  ...
  // user Tem Location
  const [userTemLocation, setUserTemLocation] =
    useState<UserTemLocation | null>(null);
  ...
  // get location
  const [locationSearch, setLocationSearch] = useState<LocationData | null>(
    null,
  );
